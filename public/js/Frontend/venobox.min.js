...
!function (e) {
    "use strict";
    var s, i, c, a, o, t, d, l, r, n, v, u, b, k, p, m, h, f, g, x, y, w, C, _, B, P, E, O, D, M, N, U, V, I, z, R, X,
        Y, j, W, q;
    e.fn.extend({
        venobox: function ($) {
            ...
            return H.cb_init(A), this.each(function () {
                ...
                A.VBclose = function () {
                    ...
                    }), d.html(""), d.css("opacity", "0"), g.css("opacity", "0"), $(), g.animate({opacity: 1}, 250, function () {
                ...
                var K = {DOWN: "touchmousedown", UP: "touchmouseup", MOVE: "touchmousemove"}, L = function (s) {
                    var i;
                    switch (s.type) {
                        case"mousedown":
                            i = K.DOWN;
                ...
                function ie() {
                    e.ajax({url: l, cache: !1}).done(function (e) {
                ...
                function de() {
                    a.html(x), d.find(">:first-child").addClass("figlio").css({
                        ...
                        e.preventDefault()
                    }), le(), d.animate({opacity: "1"}, "slow", function () {
                        E.hide()
                    })
                }
